        ...
        <footer>
                ...
                <div id ="bottomSection">
                    <div id ="socialMediaIcons">
                       <a href="#"> <img className="socialMediaIcons" id="twitterIcon" src={twitterIcon}
                             title="twitterIcon" alt="twitterIcon"/></a>
                        <a href="#">  <img className="socialMediaIcons" id="facebookIcon" src={facebookIcon}
                             title="facebookIcon" alt="facebookIcon"/></a>
                        <a href="#">  <img className="socialMediaIcons" id="youtubeIcon" src={youtubeIcon}
                             title="youtubeIcon" alt="youtubeIcon"/></a>
                        <a href="#"> <img className="socialMediaIcons" id="twitterIcon" src={instaIcon}
                             title="instaIcon" alt="instaIcon"/></a>
                        <a href="#"> <img className="socialMediaIcons" id="linkedInIcon" src={linkedInIcon}
                             title="linkedInIcon" alt="linkedInIcon"/></a>
                    </div>
