      ...
      <section className="content">
          ...
          <div className="vorteileSignBox">
            <ul className="vorteileList">
              ...
              <li>
                <div className="greenMark">✔</div>
                <p className="vorteileBeschreibung">
                  Bencom gewährt eine unkomplizierte Auftragsabwicklung und
              ...
              <li>
                ...
                <p className="vorteileBeschreibung">
                  ...
                  unterstützen Sie gerne bei der Nutzung unserer
                  Buchungsplattform
                </p>
              </li>
              <li>
        ...
        <div className="signUpBox">
          <div>
            <p className="titleSignBox">
              {" "}
              Du bist ein Student, der nach flexibler Jobs mit getem Gehalt
              sucht?{" "}
            </p>
          </div>
          <div className="vorteileSignBox">
